<template>
  <div
    class="fixed bottom-4 right-4 z-[999] flex items-center gap-2 rounded-full border border-gray-200 bg-white/90 px-3 py-2 shadow-lg backdrop-blur dark:border-gray-800 dark:bg-gray-900/90"
  >
