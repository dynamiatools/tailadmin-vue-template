...
//
// Not derived from `InstanceType<typeof PageBreadcrumbElement>` even though defineCustomElement's own
// typing looks like it should give this for free: across this package's build (declaration emit
// resolving the *value* `PageBreadcrumbElement`'s type, not a lazy type alias), that conditional type
...
export type PageBreadcrumbProps = ComponentProps<typeof Component>
