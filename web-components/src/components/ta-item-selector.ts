...
//
// Not derived from `InstanceType<typeof ItemSelectorElement>` even though defineCustomElement's own
// typing looks like it should give this for free: across this package's build (declaration emit
// resolving the *value* `ItemSelectorElement`'s type, not a lazy type alias), that conditional type
...
export type ItemSelectorProps = ComponentProps<typeof Component>
