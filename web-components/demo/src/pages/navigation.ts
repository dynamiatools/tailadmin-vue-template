...
// README's "Known limitations" section.
  {
    const el = mount('ta-command-palette', document.getElementById('demo-ta-command-palette')!, {
    modelValue: false,
    commands: [
    ...
    document.getElementById('open-demo-ta-command-palette')?.addEventListener('click', () => { el.modelValue = true })
  }
  {
    const el = mount('ta-fab', document.getElementById('demo-ta-fab')!, { icon: FolderIcon })
  }
  {
    const el = mount('ta-kanban', document.getElementById('demo-ta-kanban')!, {
    modelValue: reactive([
  ...
  {
    const el = mount('ta-menu', document.getElementById('demo-ta-menu')!, {
    items: [
